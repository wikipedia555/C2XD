...
public class MainActivity extends AppCompatActivity {
    ...
    ImageButton volumePlus1;
    ImageButton volumeMinus1;
    ImageButton  mute;
    ImageButton  pc;
    ImageButton  aux;
    ImageButton  optical;
    ImageButton  trePlus;
    ImageButton  treMinus;
    ImageButton  swPlus;
    ImageButton  swMinus;
    ImageButton  power;
    boolean state;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        volumePlus1 = (ImageButton) findViewById(R.id.plus1);
        volumeMinus1 = (ImageButton) findViewById(R.id.minus1);
        ...
        trePlus = (ImageButton) findViewById(R.id.treplus);
        treMinus = (ImageButton) findViewById(R.id.treminus);
        swPlus = (ImageButton) findViewById(R.id.swplus);
        swMinus = (ImageButton) findViewById(R.id.swminus);
        ...
        final int[] vplus = new int[]{9114,4384,687,433,689,433,687,436,687,431,692,1548,686,437,690,434,705,419,691,1539,703,1532,692,1540,689,432,691,433,702,1539,693,1533,705,1530,689,1545,689,432,692,1546,687,436,693,420,703,433,694,451,667,431,698,427,690,1550,698,422,688,1548,686,1565,670,1540,693,1540,694,1539,682};
        final int[] vminus = new int[]{9055,4439,635,475,635,498,639,473,639,486,616,1622,609,511,608,501,628,507,649,1597,632,1593,608,1631,603,512,618,506,616,1619,609,1624,615,1618,609,1623,610,1624,607,1624,624,513,610,501,610,528,596,1637,610,514,599,511,611,514,611,513,615,1624,609,1627,602,1611,622,512,616,1620,613};
        ...
        volumePlus1.setOnTouchListener(new View.OnTouchListener() {
        ...
        volumeMinus1.setOnTouchListener(new View.OnTouchListener() {
        ...
        swPlus.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable mAction = new Runnable() {
                @Override public void run() {
                    System.out.println("Performing action...");
                    try {
                        consumerIrManager.transmit(frequency, swPlusCode);
                    }
                    catch(UnsupportedOperationException e)
                    {
        ...
        swMinus.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable mAction = new Runnable() {
                @Override public void run() {
                    System.out.println("Performing action...");
                    try {
                        consumerIrManager.transmit(frequency, swMinusCode);
                    }
                    catch(UnsupportedOperationException e)
                    {
        ...
        trePlus.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable mAction = new Runnable() {
                @Override public void run() {
                    System.out.println("Performing action...");
                    try {
                        consumerIrManager.transmit(frequency, trePlusCode);
                    }
                    catch(UnsupportedOperationException e)
                    {
        ...
        treMinus.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable mAction = new Runnable() {
                @Override public void run() {
                    System.out.println("Performing action...");
                    try {
                        consumerIrManager.transmit(frequency, treMinusCode);
                    }
                    catch(UnsupportedOperationException e)
                    {
